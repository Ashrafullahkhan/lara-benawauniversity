                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            ...
                            <ul class="course-features">
                                <li>
                                    <span>Academic programmes are designed keeping in view the
                            ...
                            <ul class="course-features">
                                <li>
                                    <span>To develop professionals in the field of Computer
                            ...
                            <ul class="course-features">
                                <li>
                                    <span>Providing Educational Services to the new generation in
                                        the field of Computer Science and Research to serve for
                                        the betterment of Afghan Society.
                                    </span>
                                </li>
                                <li>
                                    <span>A lecture breakup will be prepared by each course
                                ...
                                <li>
                                    <span>Presently the following programmes of study leading to
                                        Bachelor of Computer Science are offered at BIHE.
                                    </span>
                                </li>
                                <li>
                                    <span>1 - Bachelor of Computer Science (Software Engineering)
                                    </span>
                                </li>
                                <li>
                                    <span>2 - Bachelor of Computer Science (Networking)
                                    </span>
                                </li>
                                <li>
                            ...
                            <ul class="course-features">
                                <li>
                                    <span>Software engineers design, develop and test complex
                            ...
                            <ul class="course-features">
                                <li>
                                    <span>To develop professionals in the field of Software
                            ...
                            <ul class="course-features">
                                <li>
                                    <span>Right from the day of computer automation, a computer
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr id="th" style="border:1px solid black">
                                        <th>Course No.</th>
                                        <th>Course Title</th>
                                        <th>Credit Hours</th>
                                    </tr>
