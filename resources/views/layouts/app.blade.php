              ...
              >
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="sub-menu">
                      <li>
                        <a href="admission-info.html">Admission Information</a>
                      </li>
				  ...
				  <li><a href="javascript:;"> Academic <i class="fa fa-chevron-down"></i></a>
					<ul class="sub-menu">
						<li><a href="javascript:;">Programmes<i class="fa fa-angle-right"></i></a>
							<ul class="sub-menu">
								<li><a href="Programme-CS.html">Computer Science</a></li>
								<li><a href="Programme-EN.html">Engineering</a></li>
							</ul>
						</li>
					...
					<ul class="sub-menu add-menu">
						...
						<!--	<h5 class="menu-adv-title">Our Courses</h5> -->
							<ul>
								...
								<li><a href="courses-details.html">Student Portal</a></li>
								<li><a href="Student Affairs.html">Student Affairs</a></li>
				  ...
				  <li><a href="javascript:;">Facilites<i class="fa fa-chevron-down"></i></a>
					<ul class="sub-menu">
						...
						<li><a href="Engineering-lab.html">Engineering Lab</a></li>
				  ...
				  <li class="nav-dashboard"><a href="javascript:;">About Us <i class="fa fa-chevron-down"></i></a>
					<ul class="sub-menu">
						<li><a href="why-benawa.html">Why BIHE?</a></li>
						<li><a href="admin/add-listing.html">Vision, Mission and Objectives</a></li>
						<li><a href="founder-of-benawa.html">Founder of BIHE</a></li>
						<li><a href="chacelor-message.html">Chancellor's Message</a></li>
						<li><a href="management-team.html">Management Team</a></li>
						<li><a href="admin/teacher-profile.html">Our Students</a></li>
                </ul>
