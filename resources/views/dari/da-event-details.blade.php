                            ...
                            <div class="col-lg-8 col-xl-8">
                                ...
                                <div class="recent-events blog-lg">
                                    ...
                                    <div class="info-bx">
                                        ...
                                        <h5 class="post-title pashto-font text-right"><a
                                                href="#">{{ $event->title }}</a></h5>
                                        <p class="pashto-font text-right">{{ $event->body }}</p>
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <aside class="side-bar sticky-top">
                                                    ...
                                                    <div class="ttr-post-info">
                                                        <div class="ttr-post-header">
                                                            <h6 class="post-title pashto-font text-right"><a
                                                                    href="/dr-list-of-events">{{ $row->title }}</a>
                                                            </h6>
                                                        </div>
                                                        <ul class="media-post">
                                                            <li><a href="#"><i
                                    ...
                                    <div class="widget widget_gallery gallery-grid-4">
                                        <h6 class="widget-title pashto-font text-right">گالری ما
                                        </h6>
                                        <ul>
                                            <li>
                                                <div><a href="#"><img
