        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white pashto-font">لیست رویدادها</h1>
                </div>
            </div>
        </div>
        <!-- contact area -->
                    ...
                    <div class="row">
                            ...
                            @foreach ($data as $row)
                                <div class="blog-post blog-md clearfix">
                                    ...
                                    <div class="ttr-post-info">
                                        <ul class="media-post">
                                            <li><a href="/dr-event-details/{{ $row->id }}"><i
                                        ...
                                        <div class="post-extra">
                                            <a href="/dr-event-details/{{ $row->id }}"
                                                class="btn-link pashto-font">ادامه مطلب
                                            </a>
                        ...
                        <div class="col-lg-4 sticky-top">
                            <aside class="side-bar sticky-top">
                                <div class="widget">
                                    <h6 class="widget-title pashto-font text-right">جستجو</h6>
                                ...
                                <div class="widget recent-posts-entry">
                                    <h6 class="widget-title pashto-font text-right">پستهای اخیر</h6>
                                                ...
                                                <div class="ttr-post-info">
                                                    <div class="ttr-post-header">
                                                        <h6 class="post-title pashto-font text-right"><a
                                                                href="/dr-list-of-events">{{ $row->title }}</a></h6>
                                                    </div>
                                                    <ul class="media-post">
                                                        <li><a href="#"><i
                                ...
                                <div class="widget widget_gallery gallery-grid-4">
                                    <h6 class="widget-title pashto-font text-right">گالری ما</h6>
                                    <ul>
                                        <li>
