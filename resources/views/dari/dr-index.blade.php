    ...
    <div class="page-content bg-white">
            ...
            ">
                ...
                <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display: none"
                    ...
                    ">
                            ...
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption Newspaper-Subtitle tp-resizeme pashto-font" id="slide-100-layer-4"
                                data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
        ...
        <div class="content-block">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <h4 class="pashto-font"><a href="#"> کمپیوتر لیب</a></h4>
                                    <a href="computer-lab.html" class="btn radius-xl pashto-font">مشاهده بیشتر </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <h4 class="pashto-font"><a href="#"> لیب انجینری</a></h4>
                                    <a href="Engineering-lab.html" class="btn radius-xl pashto-font">مشاهده بیشتر</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="service-bx m-b0">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <h4 class="pashto-font"><a href="#">کتاب خانه</a></h4>
                                    <a href="Library.html" class="btn radius-xl pashto-font">مشاهده بسشتر</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-area section-sp2 popular-courses-bx">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx right_line pashto-font text-right">
                            <h2 class="title-head pashto-font">برنامه های <span>مشهور
                                </span></h2>

                        </div>
                    </div>
                    <div class="row">
                        <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0" style="margin-top:40px">
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="assets/images/courses/machine leranig.jpg" alt="" />
                                        <a href="#" class="btn pashto-font">بیشتربخوانید </a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5>
                                            <a href="#" class="pashto-font">ماشین لرنینگ(فراګیری ماشین)</a>
                                        </h5>
                                        <span>برنامه نویسی</span>
                                    </div>
                                    <div class="cours-more-info">
                                        <div class="review">
                                            <span class="pashto-font">3 مرور</span>
                                            <ul class="cours-star">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5 class="pashto-font">
                                            <a href="#">دیتا بیس</a>
                                        </h5>
                                        <span class="pashto-font">برنامه نویسی</span>
                                    </div>
                                    <div class="cours-more-info">
                                        <div class="review">
                                            <span class="pashto-font">3 مرور</span>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        <h5>
                                            <a href="#" class="pashto-font">تو سعه یی برنامه های موبایل</a>
                                        </h5>
                                        <span class="pashto-font">برنامه نویسی</span>
                                    </div>
                                    <div class="cours-more-info">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        ...
                                        <a href="#" class="btn pashto-font">بیشتر</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5 class="pashto-font">
                                            <a href="#">آموزشی</a>
            ...
            <div class="section-area uppadding">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center heading-bx">
                            <h2 class="title-head m-b0 pashto-font">رویدادهای <span>آینده</span></h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-white heading-bx left">
                            <h2 class="title-head text-uppercase pashto-font">
            ...
            <div class="section-area section-sp2">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx right_line text-right ">
                            <h2 class="title-head pashto-font"> اخبار<span>اخیر</span></h2>
                            <p>
                                It is a long established fact that a reader will be
                                distracted by the readable content of a page
                            </p>
                    ...
                    <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0" style="margin-top:20px ">
                        @foreach ($news as $row)
                            <div class="item">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="heading-bx right_line text-right">
                                <h5 class="pashto-font">استادان آینده </h5>
                                <h1 class="title-head pashto-font text-right">ملا قات با استادان</h1>
                            </div>
                            <!-- section title -->
