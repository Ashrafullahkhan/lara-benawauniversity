    ...
    <div class="page-wraper">
       ...
       -->
                                        ...
                                        <li><a href="javascript:;">Proc.& Policies<i
                                            ...
                                            <ul class="sub-menu">
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Academic_staff_recruitment_policy.pdf']) }}">Academic
                                                        Staff Recruitment Policy
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Benawa_Research_Policy.pdf']) }}">
                                                        Benawa Research Policy
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Compiliation_and_translation_Policy.pdf']) }}">Compiliation
                                                        And Translation Policy

                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Conflicts_of_Intrest_in_Research_Policy.pdf']) }}">Conflicts
                                                        of Intrest in Research Policy
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Employees_grievance_policy.pdf']) }}">
                                                        Employees Grievance Policy
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Ethics_in_Research_Policy.pdf']) }}">Ethics
                                                        in Research Policy
                                                    </a></li>

                                                <li><a href="{{ url('policies', ['pdf' => 'Ethics_policy.pdf']) }}">Ethics
                                                        Policy
                                                    </a></li>
                                                <li><a href="{{ url('policies', ['pdf' => 'Gender_policy.pdf']) }}">Gender
                                                        Policy
                                                    </a></li>
                                                <li><a href="{{ url('policies', ['pdf' => 'Juctice_Policy.pdf']) }}">Justice
                                                        Policy
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Library_using_Mechanism.pdf']) }}">Library
                                                        using mechanism

                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'maintaining_and_caring_for_teaching_facilicties_Mechanism.pdf']) }}">
                                                        Maintaining and Caring for Teaching Facilicties Mechanism
                                                    </a></li>
                                                <li><a href="{{ url('policies', ['pdf' => 'Ethics_policy.pdf']) }}">Professional
                                                        Development Policy

                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Research_Guidline.pdf']) }}">Research
                                                        and Guidline
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Sponsored_Research_Policy.pdf']) }}">Sponsored
                                                        Research Policy
                                                    </a></li>
                                                <li><a
                                                        href="{{ url('policies', ['pdf' => 'Academic_Freedom.pdf']) }}">Academic
                                                        Freedom
                                                    </a></li>
                                    ...
                                    <!-- <li class="add-mega-menu">
                                                        <a href="javascript:;">Our Courses <i
                                                        ...
                                                        <ul class="sub-menu add-menu">
                                                            <li class="add-menu-left">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="courses-details.html">Courses
                                                                            Details</a>
                                                                    </li>
                                    ...
                                    <ul class="sub-menu add-menu">
                                        <li class="add-menu-left">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ url('files', ['pdf' => 'Student_HANDBOOK.pdf']) }}">HandBook

                                                    </a></li>
                                                <li><a href="academic_rules_and_regulation">Academic Rules &
                                                        Regulations</a></li>
                                                <li><a href="http://benawa.edu.af/verification.php">Student Document
                                                        Verification</a></li>
                                            </ul>
                                        </li>
                                    </ul>
