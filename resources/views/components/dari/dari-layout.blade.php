                ...
                <ul>
                  <li>
                    <select class="header-lang-bx" name="languages" id="languages"onchange="location = this.value;">
                      <option data-icon="flag flag-uk" value="index.html">انگلیسی</option>
					...
					<ul class="sub-menu">
						...
						<li><a href="javascript:;">پالیسی و پروسیجر<i class="fa fa-angle-right"></i></a>
							<ul class="sub-menu">
								...
								<li><a href="faq-2.html">پالیسی اخلاق</a></li>
							</ul>
						</li>
						</ul>
					...
					<ul class="sub-menu add-menu">
						...
						<!--	<h5 class="menu-adv-title">Our Courses</h5> -->
							<ul>
								...
								<li><a href="membership.html">تایًد اسناد محصلان</a></li>
							</ul>
						</li>
						</ul>
                  <!-- <li>
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-5 col-md-7 col-sm-12">
                <div class="row">
                  ...
                  <div class="col-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="widget footer_widget">
                      ...
                      <ul>
                        ...
                        <li><a href="portfolio.html">فورت پولیو</a></li>
                  ...
                  <div class="col-4 col-lg-4 col-md-4 col-sm-4">
                    <div class="widget footer_widget">
                      <h5 class="footer-title">برنامه ها</h5>
                      <ul>
                        <li><a href="courses.html">برنامه ها</a></li>
                        <li><a href="courses-details.html">جزیًات</a></li>
                        <li><a href="membership.html">عضویت</a></li>
                        <li><a href="profile.html">پوروفایل</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
