        ...
        <div class="page-banner ovbl-dark" style="background-image: url(assets/images/banner/banner3.jpg)">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Academic Rules & Regulations</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-bx left">
                                <h2 class="title-head">Academic Rules & Regulations</h2>
                            </div>
                            <p>
                                A high standard of decency and discipline is expected from students. All who seek
                                admission to BIHE must understand and be very clear in their minds that the Institute
                                demands a high standard of behavior from them in their manners, demeanor, speech and
                                action. They are expected to be pleasant, soft spoken, neatly and smartly dressed when
                                they attend classes and at all other times when they interact with any person in or
                                outside the campus.

                            </p>
                            <p>
                                Disorderly behavior during examinations as well as in other situations may result in
                                irrevocable dismissal from the Institute. Disciplinary Committee consisting of senior
                                faculty decides all discipline related issues and awards appropriate punishment
                                including fine, suspension from classes, etc. apart from dismissal and rustication from
                                the Institution.
                            </p>
