            ...
            <div class="col-lg-12 m-b30">
                ...
                <div class="col-lg-12 m-b30">
                    <div class="widget-box">
                        <div class="wc-title">
                            <h4>Update alumnus</h4>
                        </div>
                        <div class="widget-inner">
                            <form method="post" action="/alumuni/update/{{ $alumuni->id }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div>
                                            <textarea class="form-control" name="body">{{ $alumuni->body }} </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-4">
                                        <img src="/storage/{{ $alumuni->main_pic }}" class="img-thumbnail"
                                            width="100" />
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <button type="submit" name="alumuni" value="Save" class="btn">Update
                                            changes</button>
