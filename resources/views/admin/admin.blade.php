...
<head>
	...
	<!--[if lt IE 9]>
	<script src="admin/admin/assets/js/html5shiv.min.js"></script>
	<script src="admin/admin/assets/js/respond.min.js"></script>
	<![endif]-->
		...
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
						<a href="admin/courses" class="ttr-material-button">
					...
					<li>
						<a href="admin/listing" class="ttr-material-button">
