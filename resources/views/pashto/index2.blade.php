                      ...
                      <li><a href="index-2.html">Home 2</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="scholarships.html"> د بورسونو او د بیرته ورکولو پالیسي</a>
                                        </li>
                                        <li>
                                            <a href="financial-assistant.html"> مالي مرسته</a>
                                        </li>
                                    </ul>
                                </li>
                                <!-- <li>
                                    ...
                                    <form class="subscription-form"
                                        ...
                                        <div class="input-group">
                                            <input name="email" required="required" class="form-control"
                                                placeholder="ستاسو ایمیل ادرس" type="email" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-lg-4 col-md-4 col-sm-4">
                                    <div class="widget footer_widget">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="http://educhamp.themetrades.com/admin/index.html"> ډشبورډ</a>
                                            </li>
