        ...
        <div class="page-banner ovbl-dark" style="background-image: url(assets/images/banner/banner3.jpg)">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white pashto-font">د آنلاین داخلې سیسټم</h1>
                    <p class="text-white pashto-font">
                        د لومړي ځل لپاره BIHE یو جامع آنلاین وړاندې کوي
                        د داخلې سیسټم (admission.benawa.edu.af)، چیرې چې زده کونکي کولی شي
                        په هر وخت او هر ځای کې د داخلې لپاره غوښتنه وکړئ.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <ul class="pashto-course-features ">
                                ...
                                <li>
                                    <span class="pashto-font text-right">د داخلې فورمه</span>
                                </li>
                                <li>
                            ...
                            <ul class="pashto-course-features ">
                                <li>
                                    <span class="pashto-font text-right">د وړتیا لیست د HSC او داخلې پراساس جوړ شوی
                                        په لاندې ډول ازموینه:</span>
                                </li>
                                <li>
                                    <span class="pashto-font text-right">
                                        د HSC په ازموینه کې د ترلاسه شوي نښو برخه 20٪</span>
                                </li>
                                <li>
