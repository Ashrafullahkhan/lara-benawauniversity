        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white pashto-font">د پخوانیو محصلینو لیست</h1>
                </div>
            </div>
        </div>
        <!-- contact area -->
                            ...
                            @foreach ($data as $row)
                                <div class="blog-post blog-md clearfix">
                                    ...
                                    <div class="ttr-post-info">
                                        <ul class="media-post">
                                            <li><a href="/pa-alumni-details/{{ $row->id }}"><i
                                                        class="fa fa-calendar"></i>{{ $row->created_at }}</a>
                                            </li>

                                        </ul>
                                        <h5 class="post-title text-right"><a
                                                href="/pa-alumni-details/{{ $row->id }}"
                                                class="pashto-font">{{ substr($row->name, 0, 100) }}</a>
                                        </h5>
                                            ...
                                            <div class="widget-post clearfix">
                                                ...
                                                <div class="ttr-post-info">
                                                    <div class="ttr-post-header">
                                                        <h6 class="post-title pashto-font text-right"><a href="">
                                                                {{ substr($row->name, 0, 100) }}</a></h6>
                                                    </div>
                                                    <ul class="media-post">
                                                        <li><a href="#"><i
                                                                    class="fa fa-calendar"></i>{{ $row->created_at }}</a>
