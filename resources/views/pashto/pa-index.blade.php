                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <h4><a href="#" class="pashto-font"> د انجینرۍ لابراتوار</a></h4>
                                    <a href="#" class="btn radius-xl pashto-font"
                                        style="  font-family:'Noto Naskh Arabic',serif;
                                            direction: rtl">
                                        نور وګوره</a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="service-bx m-b0">
                                ...
                                <div class="info-bx text-center">
                                    ...
                                    <h4><a href="#" class="pashto-font"> کتابتون او پلورنځی</a></h4>
                                    <a href="#" class="btn radius-xl"
                                        style="  font-family:'Noto Naskh Arabic',serif;
                                    direction: rtl">
                                        نور وګوره</a>
                        ...
                        <div class="content-block col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0"
                                            ...
                                            <div class="item">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="assets/images/courses/machine leranig.jpg"
                                                            alt="" />
                                                        <a href="#"
                                                            style=" font-family:'Noto Naskh Arabic',serif;direction: rtl;"
                                                            class="btn pashto-font">نورواولۍ </a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5>
                                                            <a href="#" class="pashto-font">د ماشین
                                                                زدګړه(مشین
                                                                الرنینګ)</a>
                                                        </h5>
                                                        <span class="pashto-font">پروګرامینګ</span>
                                                    </div>
                                                ...
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="assets/images/courses/Database.jpg"
                                                            alt="" />
                                                        <a style=" font-family:'Noto Naskh Arabic',serif;direction: rtl;"
                                                            href="#" class="btn ">نورولولۍ</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5>
                                                            <a href="#" class="pashto-font">دیټا بیس</a>
                                                        </h5>
                                                        <span class="pashto-font">پروګرامینګ</span>
                                                    </div>
                                                    <div class="cours-more-info">
                                                        <div class="review pashto-font">
                                                            <span>3 بیاکتنه</span>
                                                            <ul class="cours-star">
                                                                <li class="active"><i class="fa fa-star"></i></li>
                                                                <li class="active"><i class="fa fa-star"></i></li>
                                            ...
                                            <div class="item">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="assets/images/courses/Mobile App.jpg"
                                                            alt="" />
                                                        <a href="#"
                                                            style=" font-family:'Noto Naskh Arabic',serif;direction: rtl;"
                                                            class="btn pashto-font">نورولولۍ</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5>
                                                            <a href="#" class="pashto-font">د موبایل اپلکیشن
                                                                پراختیا</a>
                                                        </h5>
                                                        <span class="pashto-font">پروګرامینګ</span>
                                                    </div>
                                            ...
                                            <div class="item">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="assets/images/courses/ali ullah.jpg"
                                                            alt="" />
                                                        <a style=" font-family:'Noto Naskh Arabic',serif;direction: rtl;"href="#"
                                                            class="btn pashto-font">نورولولۍ</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5>
                                                            <a href="#" class="pashto-font">زده کړه</a>
                                                        </h5>
                                                        <span class="pashto-font">پروګرامینګ</span>
                                                    </div>
                                                    <div class="cours-more-info">
                                                        <div class="review">
                                                            <span class="pashto-font">3 بیاکتنه</span>
                                                            <ul class="cours-star">
                                                                <li class="active"><i class="fa fa-star"></i></li>
                                                                <li class="active"><i class="fa fa-star"></i></li>
                                                                <li class="active"><i class="fa fa-star"></i></li>
                            ...
                            <section id="teachers-part" class="pt-70 pb-120">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="heading-bx text-right pashto-font">
                                                <h5 class="pashto-font"> ښوونکي</h5>
                                                <h1 class="title-head pashto-font"> زموږ د ښوونکو سره لیدنه وکړئ
                                                </h1>
                                            </div>
                                            <!-- section title -->
                                            <div class="teachers-cont">
                                                ...
                                                <a href="/pa_teachers" class="btn pashto-font">نور وګوره</a>
                                            </div>
                                            <!-- teachers cont -->
                                        </div>
