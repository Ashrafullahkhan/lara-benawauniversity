...
<body id="bg">
    <div class="page-wraper">
                ...
                <div class="container">
                    <div class="row d-flex justify-content-between">
                        <div class="topbar-left">
                            <ul>
                                <li>
                                    <a href="faq-1.html"><i class="fa fa-question-circle"></i>پوښتنه وکړی</a>
                                </li>
                                <li>
                      ...
                      <li><a href="index-2.html">Home 2</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="pa-scholarships"> د بورسونو او د بیرته ورکولو پالیسي</a>
                                        </li>
                                        <li>
                                            <a href="pa-financial"> مالي مرسته</a>
                                        </li>
                                    </ul>
                                </li>
                                <!-- <li>
       ...
       -->
                                        ...
                                        <li><a href="javascript:;"> پروسیجر او پالیسي<i
                    ...
                    <ul class="sub-menu add-menu">
                      ...
                      <li class="add-menu-right">
                        <img src="assets/images/adv/adv.jpg" alt="" />
                                ...
                                <li class="add-mega-menu"><a href="javascript:;"> زده کوونکي <i
                                                        ...
                                                        <div class="info-bx d-flex">
                                                            ...
                                                            <div class="event-info">
                                                                ...
                                                                <ul class="media-post">
                                                                    <li>
                                                                        <a href="#"><i
                                                                                class="fa fa-clock-o"></i> 7:00am
                                                                            8:00am</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#"><i
                                                                                class="fa fa-map-marker"></i> Berlin,
                                                                            Germany</a>
                                                                    </li>
                                                                </ul>
                                                                <p>
                                            ...
                                            <div class="item">
                                                <div class="recent-news">
                                                    ...
                                                    <div class="info-bx">
                                                        <ul class="media-post">
                                                            <li>
                                                                <a href="#"><i class="fa fa-calendar"></i>Jan 02
                                                                    2019</a>
                                                            </li>
                                                            <li>
                                                        ...
                                                        <h5 class="post-title">
                                                            <a href="blog-details.html">This Story Behind Education
                                                                Will Haunt You
                                                                Forever.</a>
                                                        </h5>
                                                        <p>
                                            ...
                                            <div class="item">
                                                <div class="recent-news">
                                                    ...
                                                    <div class="info-bx">
                                                        <ul class="media-post">
                                                            <li>
                                                                <a href="#"><i class="fa fa-calendar"></i>Feb 05
                                                                    2019</a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><i class="fa fa-user"></i>By
                                                        ...
                                                        <h5 class="post-title">
                                                            <a href="blog-details.html">What Will Education Be Like In
                                                                The Next 50
                                                                Years?</a>
                                                        </h5>
                                                        <p>
                                            ...
                                            <div class="item">
                                                <div class="recent-news">
                                                    ...
                                                    <div class="info-bx">
                                                        <ul class="media-post">
                                                            <li>
                                                                <a href="#"><i class="fa fa-calendar"></i>April
                                                                    14 2019</a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><i class="fa fa-user"></i>By
                                                        ...
                                                        <h5 class="post-title">
                                                            <a href="blog-details.html">Master The Skills Of Education
                                                                And Be.</a>
                                                        </h5>
                                                        <p>
                                                    ...
                                                    <form class="subscription-form"
                                                        ...
                                                        <div class="input-group">
                                                            <input name="email" required="required"
                                                                class="form-control" placeholder="ستاسو ایمیل ادرس"
                                                                type="email" />
