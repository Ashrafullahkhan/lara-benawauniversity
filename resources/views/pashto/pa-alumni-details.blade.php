                                ...
                                <div class="recent-news blog-lg">
                                    <div class="slideshow-container">
                                        <div class="mySlides fade1">
                                            ...
                                            <img src="/storage/{{ $alumni->main_pic }}"style="width:100%">

                                        </div>
                                        @if ($alumni->pic2)
                                            <div class="mySlides fade1">

                                                <img src="/storage/{{ $alumni->pic2 }}" style="width:100%">
                                        ...
                                        @if ($alumni->pic3)
                                            <div class="mySlides fade1">
                                                ...
                                                <img src="/storage/{{ $alumni->pic3 }}" style="width:100%">
                                    ...
                                    <div class="info-bx">
                                        <ul class="media-post">
                                            <li><a href="#"><i
                                                        class="fa fa-calendar"></i>{{ $alumni->created_at }}</a></li>
                                        </ul>
                                        <h5 class="post-title text-right"><a class="pashto-font"
                                                href="#">{{ $alumni->name }}</a></h5>
                                        <p class="pashto-font text-right">{{ $alumni->body }}</p>
                                                ...
                                                <div class="widget-post clearfix">
                                                    ...
                                                    <div class="ttr-post-info">
                                                        <div class="ttr-post-header">
                                                            <h6 class="post-title text-right pashto-font"><a
                                                                    class="pashto-font"
                                                                    href="/pa-list-of-alumuni">{{ substr($row->name, 0, 100) }}</a>
                                                            </h6>
                                                        </div>
                                                        <ul class="media-post">
                                                            <li><a href="/pa-list-of-alumuni"><i
